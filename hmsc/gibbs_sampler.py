...
class GibbsSampler():
    ...
    def sampling_routine(
        ...
        for n in tf.range(step_num):
            ...
            params["Beta"], params["Lambda"] = updateBetaLambda(params, self.modelData, self.priorHyperparams, phylo_fast_batched, tf.constant(1,dtype), dtype)
            if print_debug_flag:
            ...
            params["Gamma"], params["iV"] = updateGammaV(params, self.modelData, self.priorHyperparams, phyloFastBatched=phylo_fast_batched, dtype=dtype)
            if print_debug_flag:
            ...
            params["rhoInd"] = updateRhoInd(params, self.modelData, self.priorHyperparams, n, phylo_rho_ind_update_n, phylo_fast_batched, dtype)
